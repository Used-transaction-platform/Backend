...
public class MembershipController
{
  ...
  public ResJoinInfoParam membershipJoin(@RequestBody ReqJoinParam joinParam) {
    ...
    try {
      if (this.accountDao.newAccount(joinParam.getEmail(), joinParam.getPasswd(), joinParam.getEth_id(), joinParam.getPhone()))
      { result.setAccount(this.accountDao.getAccountByEmail(joinParam.getEmail()));
  ...
  public ResLoginInfoParam membershipLogin(@RequestBody ReqLoginParam loginParam) {
    ...
    AccountModel account = this.accountDao.getAccountByEmail(loginParam.getEmail());
  ...
  public AccountModel membershipSearch(Integer account_id) {
    ...
    return this.accountDao.getAccountByID(account_id.intValue());
  }
}
